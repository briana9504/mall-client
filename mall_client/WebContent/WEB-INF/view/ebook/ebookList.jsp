...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/categories_styles.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/categories_responsive.css">
</head>
			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="index.html"><i class="fa fa-angle-right" aria-hidden="true"></i>ebookList</a></li>
					</ul>
				</div>
					...
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							...
							<c:if test="${categoryName != null }">
								<li><a href="${pageContext.request.contextPath}/EbookListController">전체</a></li>
							</c:if>
							<c:forEach var="cName" items="${categoryList}">
								<!-- 선택된 카테고리와 선택되지 않은 카테고리 나누기 -->
								<c:if test="${cName == categoryName}">
									<li class="active"><a href="${pageContext.request.contextPath}/EbookListController?categoryName=${cName}"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>${cName}</a></li>
								</c:if>
								<c:if test="${cName != categoryName}">
									<li><a href="${pageContext.request.contextPath}/EbookListController?categoryName=${cName}">${cName}</a></li>
								</c:if>
							</c:forEach>
						</ul>
					</div>
									...
									<c:forEach var="m" items="${ebookList}">
										<div class="product-item men">
											<div class="product discount product_filter">
												...
												<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>${m.ebookState}</span></div>
...
<script src="${pageContext.request.contextPath}/js/categories_custom.js"></script>
</body>
